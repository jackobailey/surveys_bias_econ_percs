...
Survey research often proceeds as if survey respondents say what they mean. This is especially true when it comes to studying both the economic vote and voters' economic perceptions. Most often, this research assumes that differences between groups that exist *within the survey* reflect real differences that exist *outside of the survey* [@bullock2019]. My results show that this is not always the case. Some partisan bias arises due to the political survey context itself. In particular, I show that incumbent partisans report more positive economic perceptions in political compared to non-political surveys.

Why might this be the case? One explanation is that different partisans face different pressures when the economy is middling or poor. First, consider opposition partisans. When things are bad, their primed and unprimed responses should coincide. Thus, they should show little difference in partisan bias. Now consider incumbent partisans, who face the opposite pressure. For this group, political priming leads them to report that things have gotten better. Thus, the economic climate leads a gap to open between the perceptions that they report in political and non-political survey contexts. As a result, future research might find that this effect reverses when the economy is doing well.
...
<!-- ![While it is common to set wide priors on beta values where the outcome is continuous, such "non-informative" priors have perverse consequences when the outcome is ordered. This is because they make the latent scale too diffuse, thereby concentrating almost all of the prior probability mass at the two extremes of the observed ordinal outcome scale. Further, models that include many independent variables or independent variables that take extreme values worsen this problem further.](_assets/figure_a3.pdf) -->
